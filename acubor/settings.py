...
MIDDLEWARE_CLASSES = (
    ...
    'users.middleware.IPFromRequestMiddleware',
...
RECAPTCHA_PUBLIC_KEY = '6LebwfUSAAAAAGIBecqI6_z0-SS6izXUxtk3NcOF' #Change with yours
RECAPTCHA_PRIVATE_KEY = '6LebwfUSAAAAALZYI91NeyFu3gTjmqNSGA9OfO-x' #Change with yours
...
if 'OPENSHIFT_DATA_DIR' in os.environ:
    MEDIA_ROOT = os.path.join(os.environ.get('OPENSHIFT_DATA_DIR'), 'media-uploads')
else:
    # MEDIA_ROOT = os.path.join(BASE_DIR, *MEDIA_URL.strip("/").split("/"))
    MEDIA_ROOT = os.path.abspath(os.path.join(os.path.realpath('.'), '..','static', 'media-uploads'))
