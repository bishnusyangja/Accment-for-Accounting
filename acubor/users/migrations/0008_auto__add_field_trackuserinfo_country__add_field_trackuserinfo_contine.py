...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackUserInfo.country'
        db.add_column(u'users_trackuserinfo', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'TrackUserInfo.continent'
        db.add_column(u'users_trackuserinfo', 'continent',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'TrackUserInfo.timezone'
        db.add_column(u'users_trackuserinfo', 'timezone',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'TrackUserInfo.latitude'
        db.add_column(u'users_trackuserinfo', 'latitude',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'TrackUserInfo.longitude'
        db.add_column(u'users_trackuserinfo', 'longitude',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackUserInfo.country'
        db.delete_column(u'users_trackuserinfo', 'country')

        # Deleting field 'TrackUserInfo.continent'
        db.delete_column(u'users_trackuserinfo', 'continent')

        # Deleting field 'TrackUserInfo.timezone'
        db.delete_column(u'users_trackuserinfo', 'timezone')

        # Deleting field 'TrackUserInfo.latitude'
        db.delete_column(u'users_trackuserinfo', 'latitude')

        # Deleting field 'TrackUserInfo.longitude'
        db.delete_column(u'users_trackuserinfo', 'longitude')
