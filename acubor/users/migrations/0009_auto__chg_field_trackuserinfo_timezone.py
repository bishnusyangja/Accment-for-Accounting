...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrackUserInfo.timezone'
        db.alter_column(u'users_trackuserinfo', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'TrackUserInfo.timezone'
        db.alter_column(u'users_trackuserinfo', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
