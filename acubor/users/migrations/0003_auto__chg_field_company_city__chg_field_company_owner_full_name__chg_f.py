...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'company', 'city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Company.owner_full_name'
        db.alter_column(u'company', 'owner_full_name', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'Company.state'
        db.alter_column(u'company', 'state', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Company.address_line_1'
        db.alter_column(u'company', 'address_line_1', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Company.address_line_2'
        db.alter_column(u'company', 'address_line_2', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Company.zip_code'
        db.alter_column(u'company', 'zip_code', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Company.city'
        db.alter_column(u'company', 'city', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'Company.owner_full_name'
        db.alter_column(u'company', 'owner_full_name', self.gf('django.db.models.fields.TextField')(max_length=254, null=True))

        # Changing field 'Company.state'
        db.alter_column(u'company', 'state', self.gf('django.db.models.fields.TextField')(max_length=50, null=True))

        # Changing field 'Company.address_line_1'
        db.alter_column(u'company', 'address_line_1', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'Company.address_line_2'
        db.alter_column(u'company', 'address_line_2', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'Company.zip_code'
        db.alter_column(u'company', 'zip_code', self.gf('django.db.models.fields.TextField')(max_length=10, null=True))
