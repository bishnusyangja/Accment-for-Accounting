...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrackUserInfo'
        db.create_table(u'users_trackuserinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ipaddress', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'users', ['TrackUserInfo'])


    def backwards(self, orm):
        # Deleting model 'TrackUserInfo'
        db.delete_table(u'users_trackuserinfo')
    ...
    models = {
        ...
        u'users.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 1, 0, 0)'}),
