...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrackUserInfo.count'
        db.alter_column(u'users_trackuserinfo', 'count', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'TrackUserInfo.count'
        db.alter_column(u'users_trackuserinfo', 'count', self.gf('django.db.models.fields.FloatField')())
