...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.currently_activated_company'
        db.add_column(u'user', 'currently_activated_company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.currently_activated_company'
        db.delete_column(u'user', 'currently_activated_company_id')
    ...
    models = {
        ...
        u'users.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 17, 0, 0)'}),
