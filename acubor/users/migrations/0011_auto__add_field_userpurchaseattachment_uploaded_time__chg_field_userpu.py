...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPurchaseAttachment.uploaded_time'
        db.add_column(u'users_userpurchaseattachment', 'uploaded_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


        # Changing field 'UserPurchaseAttachment.uploaded_date'
        db.alter_column(u'users_userpurchaseattachment', 'uploaded_date', self.gf('django.db.models.fields.TimeField')(null=True))
        # Adding field 'UserOtherAttachment.uploaded_time'
        db.add_column(u'users_userotherattachment', 'uploaded_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'UserSalesAttachment.uploaded_time'
        db.add_column(u'users_usersalesattachment', 'uploaded_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)

        # Adding field 'UserBankAttachment.uploaded_time'
        db.add_column(u'users_userbankattachment', 'uploaded_time',
                      self.gf('django.db.models.fields.TimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPurchaseAttachment.uploaded_time'
        db.delete_column(u'users_userpurchaseattachment', 'uploaded_time')


        # Changing field 'UserPurchaseAttachment.uploaded_date'
        db.alter_column(u'users_userpurchaseattachment', 'uploaded_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'UserOtherAttachment.uploaded_time'
        db.delete_column(u'users_userotherattachment', 'uploaded_time')

        # Deleting field 'UserSalesAttachment.uploaded_time'
        db.delete_column(u'users_usersalesattachment', 'uploaded_time')

        # Deleting field 'UserBankAttachment.uploaded_time'
        db.delete_column(u'users_userbankattachment', 'uploaded_time')
    ...
    models = {
        ...
        u'users.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 3, 0, 0)'}),
        ...
        u'users.userbankattachment': {
            ...
            'uploaded_time': ('django.db.models.fields.TimeField', [], {'null': 'True'})
        },
        ...
        u'users.userpurchaseattachment': {
            ...
            'is_processed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'processed_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'uploaded_date': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'uploaded_time': ('django.db.models.fields.TimeField', [], {'null': 'True'})
        },
