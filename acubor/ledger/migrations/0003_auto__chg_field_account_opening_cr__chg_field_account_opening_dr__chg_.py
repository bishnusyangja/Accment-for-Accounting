...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.opening_cr'
        db.alter_column(u'ledger_account', 'opening_cr', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Account.opening_dr'
        db.alter_column(u'ledger_account', 'opening_dr', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Account.opening_as_on_date'
        db.alter_column(u'ledger_account', 'opening_as_on_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Account.opening_cr'
        db.alter_column(u'ledger_account', 'opening_cr', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Account.opening_dr'
        db.alter_column(u'ledger_account', 'opening_dr', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Account.opening_as_on_date'
        db.alter_column(u'ledger_account', 'opening_as_on_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'ledger.account': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'opening_as_on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
