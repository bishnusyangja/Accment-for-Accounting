...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JournalEntry.company'
        db.add_column(u'ledger_journalentry', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JournalEntry.company'
        db.delete_column(u'ledger_journalentry', 'company_id')
    ...
    models = {
        ...
        u'ledger.account': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'opening_as_on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 28, 0, 0)', 'null': 'True', 'blank': 'True'}),
