...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScratchOffLatest.employee'
        db.alter_column(u'dayjournal_scratchofflatest', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payroll.Employee'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ScratchOffLatest.employee'
        raise RuntimeError("Cannot reverse this migration. 'ScratchOffLatest.employee' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ScratchOffLatest.employee'
        db.alter_column(u'dayjournal_scratchofflatest', 'employee_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payroll.Employee']))
    ...
    models = {
        ...
        u'dayjournal.scratchofflatest': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Company']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['payroll.Employee']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
