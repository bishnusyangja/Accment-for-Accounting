...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ScratchOffLatest.employee'
        db.delete_column(u'dayjournal_scratchofflatest', 'employee_id')


    def backwards(self, orm):
        # Adding field 'ScratchOffLatest.employee'
        db.add_column(u'dayjournal_scratchofflatest', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payroll.Employee'], null=True),
                      keep_default=False)
