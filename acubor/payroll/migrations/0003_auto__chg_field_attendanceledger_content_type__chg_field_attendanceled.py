...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AttendanceLedger.content_type'
        db.alter_column(u'payroll_attendanceledger', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

        # Changing field 'AttendanceLedger.object_id'
        db.alter_column(u'payroll_attendanceledger', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AttendanceLedger.content_type'
        db.alter_column(u'payroll_attendanceledger', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))

        # Changing field 'AttendanceLedger.object_id'
        db.alter_column(u'payroll_attendanceledger', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())
