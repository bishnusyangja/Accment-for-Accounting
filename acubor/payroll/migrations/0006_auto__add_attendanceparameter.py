...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AttendanceParameter'
        db.create_table(u'payroll_attendanceparameter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('full_att', self.gf('django.db.models.fields.FloatField')(default=1)),
            ('late_att', self.gf('django.db.models.fields.FloatField')(default=0.66)),
            ('half_att', self.gf('django.db.models.fields.FloatField')(default=0.5)),
            ('early_leave', self.gf('django.db.models.fields.FloatField')(default=0.66)),
            ('abs', self.gf('django.db.models.fields.FloatField')(default=0.5)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company'])),
        ))
        db.send_create_signal(u'payroll', ['AttendanceParameter'])


    def backwards(self, orm):
        # Deleting model 'AttendanceParameter'
        db.delete_table(u'payroll_attendanceparameter')
