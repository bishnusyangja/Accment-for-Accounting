...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FixedAsset.from_account'
        db.alter_column(u'voucher_fixedasset', 'from_account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'], null=True))

        # Changing field 'FixedAsset.description'
        db.alter_column(u'voucher_fixedasset', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'CashPaymentRow.reference_no'
        db.alter_column(u'voucher_cashpaymentrow', 'reference_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'FixedAssetRow.asset_ledger'
        db.alter_column(u'voucher_fixedassetrow', 'asset_ledger_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'], null=True))

        # Changing field 'JournalVoucher.narration'
        db.alter_column(u'voucher_journalvoucher', 'narration', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'InvoiceParticular.description'
        db.alter_column('invoice_particular', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'InvoiceParticular.discount'
        db.alter_column('invoice_particular', 'discount', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'CashReceiptRow.reference_no'
        db.alter_column(u'voucher_cashreceiptrow', 'reference_no', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FixedAsset.from_account'
        raise RuntimeError("Cannot reverse this migration. 'FixedAsset.from_account' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FixedAsset.from_account'
        db.alter_column(u'voucher_fixedasset', 'from_account_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account']))

        # User chose to not deal with backwards NULL issues for 'FixedAsset.description'
        raise RuntimeError("Cannot reverse this migration. 'FixedAsset.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FixedAsset.description'
        db.alter_column(u'voucher_fixedasset', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CashPaymentRow.reference_no'
        db.alter_column(u'voucher_cashpaymentrow', 'reference_no', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # User chose to not deal with backwards NULL issues for 'FixedAssetRow.asset_ledger'
        raise RuntimeError("Cannot reverse this migration. 'FixedAssetRow.asset_ledger' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FixedAssetRow.asset_ledger'
        db.alter_column(u'voucher_fixedassetrow', 'asset_ledger_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account']))

        # User chose to not deal with backwards NULL issues for 'JournalVoucher.narration'
        raise RuntimeError("Cannot reverse this migration. 'JournalVoucher.narration' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'JournalVoucher.narration'
        db.alter_column(u'voucher_journalvoucher', 'narration', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'InvoiceParticular.description'
        raise RuntimeError("Cannot reverse this migration. 'InvoiceParticular.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'InvoiceParticular.description'
        db.alter_column('invoice_particular', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'InvoiceParticular.discount'
        db.alter_column('invoice_particular', 'discount', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'CashReceiptRow.reference_no'
        db.alter_column(u'voucher_cashreceiptrow', 'reference_no', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
    ...
    models = {
        u'ledger.account': {
            ...
            'opening_as_on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 27, 0, 0)'}),
        ...
        u'voucher.fixedassetrow': {
            ...
            'amount': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'asset_ledger': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']", 'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'voucher.journalvoucher': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'narration': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'Unapproved'", 'max_length': '10'}),
            'voucher_no': ('django.db.models.fields.IntegerField', [], {})
        },
