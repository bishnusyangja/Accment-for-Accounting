...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'voucher_purchasevoucher', 'party_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ledger.Account'], null=True))

        # Changing field 'PurchaseParticular.description'
        db.alter_column('purchase_particular', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PurchaseParticular.discount'
        db.alter_column('purchase_particular', 'discount', self.gf('django.db.models.fields.FloatField')())
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PurchaseParticular.description'
        raise RuntimeError("Cannot reverse this migration. 'PurchaseParticular.description' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PurchaseParticular.description'
        db.alter_column('purchase_particular', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'PurchaseParticular.discount'
        db.alter_column('purchase_particular', 'discount', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        u'ledger.account': {
            ...
            'opening_as_on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 1, 0, 0)'}),
