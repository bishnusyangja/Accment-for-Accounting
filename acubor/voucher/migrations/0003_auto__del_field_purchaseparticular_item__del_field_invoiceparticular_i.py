...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PurchaseParticular.item'
        db.delete_column('purchase_particular', 'item_id')

        # Deleting field 'InvoiceParticular.item'
        db.delete_column('invoice_particular', 'item_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PurchaseParticular.item'
        raise RuntimeError("Cannot reverse this migration. 'PurchaseParticular.item' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PurchaseParticular.item'
        db.add_column('purchase_particular', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'InvoiceParticular.item'
        raise RuntimeError("Cannot reverse this migration. 'InvoiceParticular.item' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'InvoiceParticular.item'
        db.add_column('invoice_particular', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Item']),
                      keep_default=False)
