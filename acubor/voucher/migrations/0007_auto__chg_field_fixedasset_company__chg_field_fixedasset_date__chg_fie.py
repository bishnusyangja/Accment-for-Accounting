...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FixedAsset.company'
        db.alter_column(u'voucher_fixedasset', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company'], null=True))

        # Changing field 'FixedAsset.date'
        db.alter_column(u'voucher_fixedasset', 'date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'FixedAsset.voucher_no'
        db.alter_column(u'voucher_fixedasset', 'voucher_no', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FixedAsset.company'
        raise RuntimeError("Cannot reverse this migration. 'FixedAsset.company' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FixedAsset.company'
        db.alter_column(u'voucher_fixedasset', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company']))

        # User chose to not deal with backwards NULL issues for 'FixedAsset.date'
        raise RuntimeError("Cannot reverse this migration. 'FixedAsset.date' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FixedAsset.date'
        db.alter_column(u'voucher_fixedasset', 'date', self.gf('django.db.models.fields.DateField')())

        # User chose to not deal with backwards NULL issues for 'FixedAsset.voucher_no'
        raise RuntimeError("Cannot reverse this migration. 'FixedAsset.voucher_no' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'FixedAsset.voucher_no'
        db.alter_column(u'voucher_fixedasset', 'voucher_no', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        u'ledger.account': {
            ...
            'opening_as_on_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 6, 0, 0)'}),
        ...
        u'voucher.fixedasset': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Unapproved'", 'max_length': '10'}),
            'voucher_no': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'voucher.purchasevoucher': {
            ...
            'due_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ledger.Account']", 'null': 'True'}),
