...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InventoryLedger.rate'
        db.delete_column(u'inventory_inventoryledger', 'rate')

        # Adding field 'InventoryLedger.in_rate'
        db.add_column(u'inventory_inventoryledger', 'in_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'InventoryLedger.out_rate'
        db.add_column(u'inventory_inventoryledger', 'out_rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InventoryLedger.rate'
        db.add_column(u'inventory_inventoryledger', 'rate',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'InventoryLedger.in_rate'
        db.delete_column(u'inventory_inventoryledger', 'in_rate')

        # Deleting field 'InventoryLedger.out_rate'
        db.delete_column(u'inventory_inventoryledger', 'out_rate')
    ...
    models = {
        ...
        u'inventory.inventoryledger': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_quantity': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'in_rate': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'out_quantity': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'out_rate': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        u'inventory.item': {
