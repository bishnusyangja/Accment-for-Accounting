...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InventoryLedger.quantity'
        db.delete_column(u'inventory_inventoryledger', 'quantity')

        # Adding field 'InventoryLedger.in_quantity'
        db.add_column(u'inventory_inventoryledger', 'in_quantity',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'InventoryLedger.out_quantity'
        db.add_column(u'inventory_inventoryledger', 'out_quantity',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InventoryLedger.quantity'
        db.add_column(u'inventory_inventoryledger', 'quantity',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Deleting field 'InventoryLedger.in_quantity'
        db.delete_column(u'inventory_inventoryledger', 'in_quantity')

        # Deleting field 'InventoryLedger.out_quantity'
        db.delete_column(u'inventory_inventoryledger', 'out_quantity')
