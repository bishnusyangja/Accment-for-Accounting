...
window.month=id;var el="#"+id+"-tab";$(el).parent().attr('class','active');ajax_request(id,vm.employee);});});});function attendance_parameter(obj){$.ajax({url:'payroll/attendance-parameter.json',});}
