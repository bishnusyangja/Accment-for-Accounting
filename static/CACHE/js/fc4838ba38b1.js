...
if(sum==0){sum='0.00';}
sum=sum.toString()+' Days';return sum;});self.hour_attendance_status=ko.computed(function(){if(this.attendance_type()=='hour_attendance')return true;},this);self.day_attendance_status=ko.computed(function(){if(this.attendance_type()=='day_attendance')return true;},this);self.if_changed=function(){ajax_request(window.month,self.employee);}
