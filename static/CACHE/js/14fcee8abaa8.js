...
self[k]=ko.observable(row[k]);}
self.closing=ko.computed(function(){console.log((self.purchase()),(self.sales()));return rnum(parseFloat(self.purchase())-parseFloat(self.sales()));});self.difference=function(){return rnum(self.actual()-self.closing());};}
