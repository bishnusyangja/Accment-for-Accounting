...
self.inventory_items_except_category=function(category){var filtered_items_except=[];for(var i in self.inventory_items){if(self.inventory_items[i].category!=category)
filtered_items_except.push(self.inventory_items[i]);}
return filtered_items_except;}
