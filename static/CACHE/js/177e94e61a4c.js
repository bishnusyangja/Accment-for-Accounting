...
function set_url(id){var elem=$("a").filter(function(){if(this.text=="Profit/Loss"){return this.attr('href',"/report/profit-and-loss");}
else{var temp="/ledger/"+id;return this.attr('href',temp);}})}
